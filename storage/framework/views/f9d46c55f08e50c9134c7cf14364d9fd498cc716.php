...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav">
        ...
        <li class="nav-item">
            <a href="<?php echo e(route('masterschool.index')); ?>" class="nav-link"> <span class="menu-title"><?php echo e(__('School')); ?></span> <i class="fa fa-school menu-icon"></i> </a>
        </li>
        <li class="nav-item">
...
<?php /**PATH /var/www/html/internexaschool/resources/views/layouts/sidebar.blade.php ENDPATH**/ ?>